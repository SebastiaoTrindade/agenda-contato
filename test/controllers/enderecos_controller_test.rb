...
class EnderecosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post enderecos_url, params: { endereco: { cidade: @endereco.cidade, contato_id: @endereco.contato_id, estado: @endereco.estado, rua: @endereco.rua } }
    end
  ...
  test "should update endereco" do
    patch endereco_url(@endereco), params: { endereco: { cidade: @endereco.cidade, contato_id: @endereco.contato_id, estado: @endereco.estado, rua: @endereco.rua } }
